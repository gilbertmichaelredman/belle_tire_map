...
# Load Belle Tire stores data
print('Loading Belle Tire data...')
df_belle_tire = pd.read_csv("illinois_results.csv")
print('Belle Tire data loaded')
# Verify column names
print("Columns in the Belle Tire data:", df_belle_tire.columns)

# Load Competitor stores data
...
print(df_competitors[['ADDRESS', 'ZIP']].head())
# Verify column names
print("Columns in the competitor data:", df_competitors.columns)
...
print('Calculating competitors near each Belle Tire store...')
